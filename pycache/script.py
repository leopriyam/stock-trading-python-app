...
SNOWFLAKE_USER = os.getenv("SNOWFLAKE_USER", "PRIYAM1991")
SNOWFLAKE_PASSWORD = os.getenv("SNOWFLAKE_PASSWORD", "Changeme@12345")
SNOWFLAKE_ACCOUNT = os.getenv("SNOWFLAKE_ACCOUNT", "GHSXTHO-HLC50951")
